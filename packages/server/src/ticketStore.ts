...
import { resolveRunProfile } from '@open-alive/core';
import type { Ticket, TicketCreateInput } from '@open-alive/core';

const DEFAULT_FILE = join(homedir(), '.open-alive', 'tickets.json');
