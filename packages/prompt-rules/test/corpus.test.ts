...
// The labelled corpus is not shipped in this repository; drop *.jsonl files
// into docs/corpora/ to run this suite locally.
describe.skipIf(!existsSync(CORPUS_DIR))('corpus regression', () => {
