...
Requirements / 필요 도구: macOS, Linux or WSL2 (native Windows is not supported / Windows 직접 실행 미지원), Node.js ≥ 20 (LTS 20/22/24 recommended / LTS 권장), pnpm ≥ 10, git. Python 3 is optional (Efficio).
