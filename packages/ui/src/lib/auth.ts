 ...
 * one of two ways: `open-alive start` opens the dashboard with `?token=…`
...
export const TOKEN_STORAGE_KEY = 'open-alive.token';
const WS_TOKEN_PROTOCOL_PREFIX = 'open-alive.token.';
