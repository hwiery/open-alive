...
const toast: ToastItem = {
  id: 't1',
  type: 'warning',
  title: 'open-alive · Needs permission',
  stage: 'Needs permission',
  lines: ['Folder: ~/Documents/open-alive', 'Input: "move the toast"', 'Tool: Bash'],
  timestamp: 0,
};
...
describe('ToastContainer', () => {
  ...
  it('shows the project, stage and every detail line', () => {
    render(<ToastContainer toasts={[toast]} onDismiss={() => {}} />);
    expect(screen.getByText('open-alive · Needs permission')).toBeTruthy();
