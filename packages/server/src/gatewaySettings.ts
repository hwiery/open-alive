 ...
 *
 * Reads and writes the same two files `open-alive setup` does —
 * `~/.open-alive/.env` (LITELLM_BASE_URL, LITELLM_KEY; mode 0600) and
 * `~/.open-alive/models.json` — mirrors the change into the process env, then
