...
import type { WSServerMessage } from '@open-alive/core';
import i18n from '@open-alive/i18n';
...
class ErrorBoundary extends Component<{ children: ReactNode }, { hasError: boolean; error: Error | null }> {
  ...
  componentDidCatch(error: Error, info: React.ErrorInfo) {
    console.error('[open-alive] UI error:', error, info.componentStack);
  }
  render() {
...
export default function App() {
  ...
  useEffect(() => {
    ...
    window.addEventListener('open-alive:navigate', onNavigate);
    return () => {
      ...
      window.removeEventListener('open-alive:navigate', onNavigate);
    };
