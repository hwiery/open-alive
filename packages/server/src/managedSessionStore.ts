...
import type { ResumableSession, TerminalMode } from '@open-alive/core';

/**
 * Disk-persisted registry of UI-spawned Claude sessions. Mirrors the nameStore
 * pattern: a single JSON file under ~/.open-alive, an in-memory cache, and a
 ...
 */
const STORE_DIR = join(homedir(), '.open-alive');
