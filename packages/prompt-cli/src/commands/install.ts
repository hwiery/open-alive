import { getPaths, loadConfig, openDb } from '@open-alive/prompt-core';
...
export interface InstallOptions {
   ...
   * once open-alive-prompt was absorbed into open-alive, the standalone
 ...
 *
 * Invoked by `open-alive install` (which imports this directly from the
 * `@open-alive/prompt-cli` workspace package after the D-048 absorption)
