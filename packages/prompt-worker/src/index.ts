/**
 * @open-alive/prompt-worker — library export of the queue-consumer loop.
 *
 * As of D-048+ absorption into open-alive, this is no longer a
 * standalone Node process. open-alive's server imports
