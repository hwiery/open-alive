...
import type { EfficioAxisKey, EfficioAxisStatus, EfficioStatus, EfficioTimelineRow } from '@open-alive/core';

// Local mirror of core's AXES. We deliberately avoid importing the value
// from @open-alive/core: that package's runtime entry pulls in node:readline
